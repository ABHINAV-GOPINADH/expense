      ...
      <div className="space-y-6">
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="mt-1 text-sm text-gray-500">Manage users, roles, and permissions for your organization.</p>
          </div>
          <button
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {filteredUsers.map((user) => (
                  <tr key={user.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="flex items-center">
                        <div className="flex-shrink-0 mr-2">{getRoleIcon(user.role)}</div>
                        <span
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                      {user.managerId ? mockUsers.find((u) => u.id === user.managerId)?.name || "Unknown" : "N/A"}
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
                      <span
                        className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${
                  ...
                  {newUser.role === "employee" && (
                    <div className="border-t pt-6">
                      ...
                      <div className="space-y-4">
                          ...
                          <div className="space-y-4">
                            <div>
                              ...
                              <input
                                ...
                                value={newUser.approvalPercentage}
                                onChange={(e) =>
                                  setNewUser({ ...newUser, approvalPercentage: parseInt(e.target.value) })
                                }
                              />
                            </div>
                            <div>
                        ...
                        <div>
                          <label
                            htmlFor="minimumApprovalPercentage"
